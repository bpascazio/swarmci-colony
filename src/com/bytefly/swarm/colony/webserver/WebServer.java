...
public class WebServer extends Thread {
	...
	public WebServer(int listen_port, ColonyStarter to_send_message_to) {
	...
	private ColonyStarter message_to; // the starter class, needed for gui
	...
	public void run() {
		...
		try {
			...
			s("Trying to bind to server on port " + Integer.toString(port)
					+ "...");
